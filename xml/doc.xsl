        ...
        <xsl:for-each select="str:split(substring-after($desc, '{@'), '{@')">
            ...
            <xsl:choose>
                <xsl:when test="$type='param'">
                    <a href="#{$context}_param_{$name}">
                        &lt;<xsl:value-of select="$name"/>&gt;
                    </a>
                </xsl:when>
                <xsl:when test="$type='field'">
                    <a href="#{$class}_field_{$name}">
                        <xsl:value-of select="$name"/>
                    </a>
                </xsl:when>
                <xsl:otherwise>
                        ...
                        <table>
                            ...
                            <tbody>
                                <xsl:for-each select="constructor">
                                    <tr>
                                        <td>
                                            <p style="margin:0px; line-height:90%">
                                                <xsl:call-template name="select-visibility">
                                                    <xsl:with-param name="def">public</xsl:with-param>
                                                </xsl:call-template>&#160;
                                                ...
                                                <xsl:if test="brief">
                                                    <br/>
                                                    <span style="margin-left:20pt; font-size:10pt">
                                                        <xsl:copy-of select="brief"/>
                                                    </span>
                                                </xsl:if>
                                            </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <xsl:choose>
                                                ...
                                                <xsl:when test="not(@setter='false')">set
                                                </xsl:when>
                                                <xsl:otherwise>get
                                                </xsl:otherwise>
                                            </xsl:choose>
                                ...
                                <xsl:for-each select="method">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p style="margin:0px; line-height:90%">
                                                <b>
                                                    <a href="#{$class}_method_{@name}_{position()}">
                                                        <xsl:value-of select="@name"/>
                                                    </a>
                                                </b>
                                                (
                        ...
                        <xsl:if test="value">
                            ...
                            <tbody>
                                <xsl:for-each select="value">
                                    <tr>
                                        <td><xls:value-of select="@name"/></td>
                                        <td><xls:value-of select="@val"/></td>
                                        <td><xls:value-of select="text()"/></td>
                                    </tr>
                                </xsl:for-each>
                            </tbody>
                            </table>
                            ...
                            <p id="{$tag}">
                                ...
                                <span style="font-size: 10pt">
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:when test="not(@setter='false')">setter only
                                        </xsl:when>
                                        <xsl:otherwise>getter only
                                        </xsl:otherwise>
                                    </xsl:choose>
                                    )
                                    <xsl:if test="text()!='' or brief">
                                        <br/>
                                        <xsl:call-template name="description">
                                            <xsl:with-param name="context" select="$tag"/>
                                            <xsl:with-param name="class" select="$class"/>
                    ...
                    <xsl:if test="method">
                        ...
                        <xsl:for-each select="method">
                            ...
                            <p id="{$tag}">
                                ...
                                <xsl:if test="return or (@return != 'void')">
                                    <table>
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <xsl:choose>
                                                <xsl:when test="@return='this' and not(return)">
                                                    <tr>
                                                        <td>
                                                            <a href="#{@class}">
                                                                <xsl:value-of select="$class"/>
                                                ...
                                                <xsl:when test="@return and not(return)">
                                                    <tr>
                                                        <td>
                                                            <a href="#{@return}">
